...
set_time_limit(0);
$startUrl = "http://www.youtube.com/user/standupcomedyindo/feed?filter=2";
...
$data = scrapeYoutube("http://www.youtube.com/user/standupcomedyindo/feed?filter=2");
